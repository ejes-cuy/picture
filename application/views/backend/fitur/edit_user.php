...
<div class="container pt-2 ">
    <div class="card-body">
            <h5 class="text-center">Edit data User</h5>
        <div class="row">
        <div class="col-md-12">
            <div mb-2>
            ...
            <div class="ibox-body">
                <form class="form-horizontal" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="nip" value="<?= $users->nip ?>" >
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="no_hp" value="<?= $users->no_hp ?>">
                        </div>
                    </div> 
